...
func (x *categoryServiceCreateCategoryBidirectionalStreamClient) Send(m *CategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}
...
func (x *categoryServiceCreateCategoryBidirectionalStreamServer) Recv() (*CategoryRequest, error) {
	m := new(CategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
